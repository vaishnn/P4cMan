...
class GraphWidget(QGraphicsView):
    ...
    def _parameters(self):
        ...
        # Saving last state of the bodies when being dragged
    ...
    def _create_bodies_and_nodes(self):
        ...
        for idx, node_id in enumerate(self.graph.nodes()):
            ...
            body.position = self.graph_nodes_position[node_id]
    ...
    def mousePressEvent(self, event) -> None:
        ...
        if event.button() == Qt.MouseButton.LeftButton:
            ...
            if shape_info:
                ...
                self.modified_bodies[dragged_body] = dragged_body.velocity_func
                ...
                for neighbour_id in self.graph.neighbors(dragged_node_id):
                    ...
                    if neighbour not in self.modified_bodies:
                        self.modified_bodies[neighbour] = neighbour.velocity_func
    ...
    def mouseReleaseEvent(self, event) -> None:
        ...
        if event.button() == Qt.MouseButton.LeftButton:
            ...
            for body, original_func in self.modified_bodies.items():
                body.velocity_func = original_func
